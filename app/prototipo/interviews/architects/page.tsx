    ...
    <div className="relative w-full min-h-screen bg-white" ref={revealRef}>
      ...
      <div className="absolute top-[66px] left-0 right-0 z-40 px-[32px] pt-[16px]">
        <p className="text-[14px] font-normal" style={{ lineHeight: "22px", letterSpacing: "-0.28px" }}>
          ...
          <span style={{ color: "rgba(0, 0, 0, 0.50)" }}> · </span>
          <span className="text-black font-medium">Architects</span>
        </p>
      </div>

      {/* 1. Entre bosques y planos — mid, 5 col */}
          ...
          <div className="col-start-4 col-span-5 reveal">
            <ArticleThumbnail
              ...
              article={{
                ...
                title: "Entre bosques y planos: Laura Vidal",
        ...
        <div className="grid-12">
          <div className="col-start-8 col-span-3 reveal">
            <ArticleThumbnail
              variant="small"
              article={{
                image: "/images/interview-architect-ali.jpg",
                title: "Rigor y vision: Marcus Webb",
                category: "Entrevistas · Architects",
              }}
            />
          </div>
      ...
      {/* 3. Donde termina la tierra — super, full width */}
      <div className="pt-[180px] reveal">
        <ArticleThumbnail
          variant="super"
          article={{
            image: "/images/interview-architect-karl.jpg",
            title: "Donde termina la tierra",
            category: "Entrevistas · Architects",
          }}
      ...
      {/* 4. Construir con las manos — mid, 5 col */}
      <div className="grid-container pt-[180px]">
        <div className="grid-12">
          <div className="col-start-2 col-span-5 reveal">
            <ArticleThumbnail
              variant="mid"
              article={{
                image: "/images/interview-architect-daniel.jpg",
                title: "Construir con las manos: Pedro Salinas",
                category: "Entrevistas · Architects",
              }}
            />
          </div>
              ...
              {SUBS.map((sub, i) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      setActiveSub(i);
                      if (subHrefs[sub] && sub !== "Architects") navigateTo(subHrefs[sub]);
                    }}
                    className="cursor-pointer transition-opacity duration-300"
