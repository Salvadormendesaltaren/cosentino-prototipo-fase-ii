    ...
    <div className="relative w-full min-h-screen bg-white overflow-x-hidden" ref={revealRef}>
      ...
      <div className="absolute top-[66px] left-0 right-0 z-40 px-[32px] pt-[16px]">
        <p className="text-[14px] font-normal" style={{ lineHeight: "22px", letterSpacing: "-0.28px" }}>
          ...
          <span style={{ color: "rgba(0, 0, 0, 0.50)" }}> · </span>
          <span className="text-black font-medium">Offices</span>
        </p>
      </div>

      {/* 1. Cristal al anochecer — mid, 5 col, col-start-4 */}
          ...
          <div className="col-start-4 col-span-5 reveal">
            <ArticleThumbnail
              ...
              article={{
                ...
                title: "Cristal al anochecer: la oficina transparente",
      ...
      {/* 2. Repetición y orden — small, 3 col, col-start-8 */}
          ...
          <div className="col-start-8 col-span-3 reveal">
            <ArticleThumbnail
              ...
              article={{
                ...
                title: "Repetición y orden: la grilla como lenguaje",
                category: "Contract · Offices",
              }}
            />
          </div>
      ...
      {/* 3. Horizontales de piedra y cielo — big, 6 col, col-start-2 */}
      <div className="grid-container pt-[180px]">
        <div className="grid-12">
          <div className="col-start-2 col-span-6 reveal">
            <ArticleThumbnail
              ...
              article={{
                ...
                title: "Horizontales de piedra y cielo",
                category: "Contract · Offices",
              }}
            />
          </div>
      ...
      {/* 5. Pliegues metálicos — small, 3 col, col-start-5 */}
      <div className="grid-container pt-[180px]">
        <div className="grid-12">
          <div className="col-start-5 col-span-3 reveal">
            <ArticleThumbnail
              ...
              article={{
                ...
                title: "Pliegues metálicos: la piel del edificio",
                category: "Contract · Offices",
              }}
            />
          </div>
              ...
              {SUBS.map((sub, i) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      setActiveSub(i);
                      if (subHrefs[sub] && sub !== "Offices") navigateTo(subHrefs[sub]);
                    }}
                    className="cursor-pointer transition-opacity duration-300"
