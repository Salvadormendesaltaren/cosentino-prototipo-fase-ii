    ...
    <div className="relative w-full min-h-screen bg-white" ref={revealRef}>
      ...
      <div className="absolute top-[66px] left-0 right-0 z-40 px-[32px] pt-[16px]">
        <p className="text-[14px] font-normal" style={{ lineHeight: "22px", letterSpacing: "-0.28px" }}>
          ...
          <span style={{ color: "rgba(0, 0, 0, 0.50)" }}> · </span>
          <span className="text-black font-medium">Bathrooms</span>
        </p>
      </div>

      {/* 1. Homenaje al blanco — mid, 5 col, centro-derecha */}
        ...
        <div className="grid-12">
          <div className="col-start-5 col-span-5 reveal">
            <ArticleThumbnail
              variant="mid"
              article={{
                image: "/images/bath-piedra.png",
                title: "Homenaje al blanco",
      ...
      {/* 2. Combinar para ganar — small, 3 col, centro-derecha */}
      <div className="grid-container pt-[180px]">
        <div className="grid-12">
          <div className="col-start-6 col-span-3 reveal">
            <ArticleThumbnail
              variant="small"
              article={{
                image: "/images/bath-combinar.png",
                title: "Combinar para ganar",
                category: "Espacios · Baños",
              }}
            />
          </div>
      ...
      {/* 3. De la piedra a la tierra — small, 4 col, izquierda */}
      <div className="grid-container pt-[180px]">
        <div className="grid-12">
          <div className="col-start-1 col-span-4 reveal">
            <ArticleThumbnail
              variant="small"
              article={{
                image: "/images/bath-vida-natural.png",
                title: "De la piedra a la tierra",
                category: "Espacios · Baños",
              }}
            />
          </div>
      ...
      {/* 4. Hero — Una vida natural — super, full width */}
      <div className="pt-[180px] reveal">
        <ArticleThumbnail
          variant="super"
          article={{
            image: "/images/bath-homenaje.png",
            title: "Una vida normal",
            category: "Espacios · Baños",
          }}
              ...
              {SUBS.map((sub, i) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      setActiveSub(i);
                      if (subHrefs[sub] && sub !== "Bathrooms") navigateTo(subHrefs[sub]);
                    }}
                    className="cursor-pointer transition-opacity duration-300"
